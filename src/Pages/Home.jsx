...
export default function Home() {
  ...
  return (
    <div className="text-center mt-3" style={{ marginBottom: "1rem" }}>
      ...
      >
        📚REACT PROJECT ON LIBRARY MANAGEMENT📚
      </h1>
      <Link to="/add">
        <Button
          style={{
      ...
      <Table className="mt-2" striped bordered hover>
        ...
        <tbody>
          {books.map((item, i) => (
            <BookList key={i} data={item} handleDelete={handleDelete} />
          ))}
        </tbody>
      </Table>
    </div>
    ...
    <>
      <tr className="row">
        ...
        <td>
          ...
          <FaTrash
            style={{ fontSize: "1rem", paddingLeft: "1rem", color: "red" }}
